...
def initialize(states, tag_counts, A, B, corpus, vocab):
    ...
    for i in range(num_tags): # complete this line
        ...
        # For all other cases when transition from start token to POS tag i is non-zero:
            ...
            best_probs[i,0] = np.log(𝐴[𝑠_𝑖𝑑𝑥,𝑖])+np.log(B[i,vocab[corpus[0]]])
...
def viterbi_forward(A, B, test_corpus, best_probs, best_paths, vocab):
    ...
    # Go through every word in the 00corpus starting from word 1
    ...
    for i in range(1, len(test_corpus)): 
        ...
        for j in range(num_tags): # complete this line
            ...
            for k in range(num_tags): # complete this line
                ...
                prob =  best_probs[k,i-1]+np.log(𝐴[k,j])+np.log(B[j,vocab[test_corpus[i]]])
...
def viterbi_backward(best_probs, best_paths, corpus, states):
    ...
    for k in range(num_tags): # complete this line
        ...
        if  best_prob_for_last_word<best_probs[k,m-1]: # complete this line
